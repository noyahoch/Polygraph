...
class OfflineRenderTests(unittest.TestCase):
    ...
    def test_site_separates_journey_and_full_explanation(self):
        ...
        self.assertIn('lang="he" dir="rtl"', summary)
        self.assertIn("הדרך שעברנו", summary)
        self.assertIn("Layer stack", summary)
        self.assertIn("לא מודל חדש ולא שילוב תחזיות", summary)
        self.assertIn('id="methods-chart"', summary)
        self.assertIn('id="earlier-chart"', summary)
