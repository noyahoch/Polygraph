...
This is exploratory reuse of development data. Point estimates use the original fitted models, not bootstrap-refit averages. The three seeds are 7, 17 and 27 and are never resampled.
